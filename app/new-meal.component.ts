...
@Component({
  ...
  template: `
    <div>
      <h2>Enter a Meal to Your Daily Log</h2>
      ...
      <button (click)="addNewMeal(newName, newDetails, newCalories)" type="button" class="btn btn-lg btn-success">Enter a Meal</button>
    </div>
  `
})
